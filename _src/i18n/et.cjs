module.exports = {
  ...
  hero: {
    ...
    fCountries: 'riiki',
    fPrice: 'ühe korra, ilma kuutasuta'
  },
  offer: {
  ...
  clients: {
    eye: 'Kliendid',
    h2: 'Algas tasuta kavandist. *Nüüd on see nende koduleht.*',
    lead: 'Need ettevõtted ütlesid „jah“. Igaüks sai terve kodulehe oma domeenil, oma keeles — ja kõik failid.',
    live: 'Töötab',
    soon: 'Peagi',
    visit: 'Ava {domain} ↗',
    preview: 'Vaata kodulehte ↗',
    concept: 'Esimene kavand →'
  },
  work: {
    eye: 'Tööd',
    h2: '{sites} avalehte päris ettevõtetele *{countries} riigis.*',
    lead: 'Enamik neist on kavandid: tehtud iga ettevõtte avalikest fotodest ja tekstidest, ilma tellimuseta, tasuta esimese sammuna. Filtreerige riigi või valdkonna järgi, puudutage kaarti, et lähemalt vaadata.',
    byCountry: 'Riik',
    byTrade: 'Valdkond',
    all: 'Kõik',
    mapCap: 'Iga punkt on linn, kus mõni ettevõte sai minult lehe. Puudutage riiki, et filtreerida.',
    badgeConcept: 'Kavand · mitte ametlik leht',
    badgeLive: 'Kliendi koduleht',
    badgeClient: 'Kliendi koduleht · peagi',
    altDesktop: 'avaleht sülearvutis',
    altPhone: 'avaleht telefonis',
    more: 'Näita kõiki {n}',
    empty: 'Siin pole veel midagi. Siin võiks olla teie ettevõte.',
    labs: 'Mitte ainult avalehed'
  },
  ba: {
    eye: 'Enne / pärast',
  ...
  proc: {
    eye: 'Kuidas see käib',
    h2: 'Te ei riski millegagi, *enne kui olete lehte näinud.*',
    lead: 'Neli sammu, tavaliselt ühe nädala jooksul. Helistada pole vaja: kõik käib kirjalikult ja teie keeles.',
    steps: [
  ...
  faq: {
    eye: 'Küsimused',
    h2: 'Mida omanikud *kõigepealt küsivad.*',
    items: [
      ...
      ['Te olete Ukrainas. Kas see pole risk?', 'Teie leht ja failid asuvad serverites väljaspool Ukrainat, nii et miski ei sõltu minu elektrivõrgust. Ja vastan päeva jooksul.']
    ]
  },
  about: {
    eye: 'Minust',
    ...
    f1: 'kodulehte ja kavandit päris ettevõtetele',
    f2: 'keelt, milles kirjutan klientidele',
    f3: 'päeva esimesest kirjast teie kavandini',
    f4: 'et näha oma kavandit'
  },
  start: {
    eye: 'Alusta',
    h2: 'Saage tasuta kavand *oma avalehest.*',
    lead: 'Kirjutage, millisest ettevõttest on jutt. Vastan päeva jooksul, kavand on tavaliselt valmis päeva-kahega.',
    subjectPlain: 'Koduleht minu ettevõttele',
    copy: 'Kopeeri e-post',
    answer: 'Vastan päeva jooksul.',
    qr: 'Skaneerige, et avada see leht telefonis',
    qrAria: 'QR-kood selle lehe aadressiga',
    fBiz: 'Ettevõtte nimi', pBiz: 'nt TULU PH, lukksepp',
    fLink: 'Teie koduleht või Facebooki leht', pLink: 'facebook.com/…',
    fCity: 'Linn', pCity: 'nt Tartu',
    fNote: 'Mida peaksin teadma? (valikuline)', pNote: 'Mis teile praeguse lehe juures ei meeldi?',
    send: 'Koosta kiri',
    sendNote: 'Avaneb teie e-post selle tekstiga. Midagi ei saadeta enne, kui vajutate „Saada“.'
  },
  ...
  rt: {
    ...
    noteClient: 'Tehtud kliendile; peagi tema enda domeenil.',
    count: '{i} / {n}',
    hiTitle: 'Tere, {name}!',
    ...
    copied: 'Kopeeritud: {mail}',
    answer: 'Vastan päeva jooksul.',
    mailSubject: 'Tasuta kavand: {biz}',
    mailHello: 'Tere, Artur!',
    mailAsk: 'Soovin tasuta avalehe kavandit.',
    mailBiz: 'Ettevõte', mailLink: 'Koduleht / Facebook', mailCity: 'Linn',
    suggest: 'See leht on ka eesti keeles.', suggestGo: 'Vaheta',
    showAll: 'Näita kõiki {n}'
  }
};
